...
export default function Home() {
  ...
  useEffect(() => {
    if (
      ...
      console.log(
        "Setting up countdown timer, current seconds:",
        message.secondsLeft
      );
      ...
      <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 to-yellow-50 p-4">
        ...
        {pageState === "no" && (
          <div className="animate-bounce-in">
            <h1 className="text-8xl md:text-9xl font-black text-red-600">NO</h1>
          </div>
        )}
          ...
          <div className="w-full max-w-md space-y-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600">
                Send a{" "}
                <span className="font-bold text-orange-500 text-2xl">REAL</span>{" "}
                text message to Noah
                <br />
                to demand sandwiches NOW!
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
              ...
              {totalCount !== null && (
                <div className="text-center text-gray-600 mt-4">
                  <p className="text-sm">
                    Total sandwich requests sent to Noah:
                  </p>
